# User Profile & Activity Feed Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a modern, Glassmorphism-style User Profile page and Activity Feed.

**Architecture:** Create a new `Profile.vue` page that fetches and displays user information and activities. Use Lucide icons for visual representation and monochrome glassmorphism for styling.

**Tech Stack:** Vue 3, TypeScript, Pinia (Auth Store), Lucide Vue Next, Axios, Tailwind CSS (v4).

---

### Task 1: Create Profile Page Component

**Files:**
- Create: `frontend/src/pages/Profile.vue`

- [ ] **Step 1: Scaffolding Profile.vue**
...
- [ ] **Step 2: Commit Profile.vue**

```bash
git add frontend/src/pages/Profile.vue
git commit -m "feat: add user profile and activities page"
```
...
### Task 3: Link Author Names in PostCard

**Files:**
- Modify: `frontend/src/components/PostCard.vue`

- [ ] **Step 1: Update author link**
...
- [ ] **Step 2: Commit PostCard changes**

```bash
git add frontend/src/components/PostCard.vue
git commit -m "feat: link author names to profiles in PostCard"
```

---

### Task 4: Link Welcome Message in Navbar

**Files:**
- Modify: `frontend/src/components/Navbar.vue`

- [ ] **Step 1: Update welcome message link**
...
git commit -m "feat: link welcome message to user profile in Navbar"
```
...
Ensure all Lucide icons are imported correctly and Tailwind classes match the monochrome glassmorphism style.
