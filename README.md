...
- **数据库**: MySQL + [sqlx](https://github.com/jmoiron/sqlx) - 关系型数据存储
...
> ⚠️ **注意**: 项目中暂无 SQL 建表脚本,请参考 `教学文档/` 中的表结构说明手动创建表,或联系项目维护者获取完整的 SQL 文件。
...
users := GetUsersByIDs(userIDs)  // 1 次
```
...
- [sqlx](https://github.com/jmoiron/sqlx) - 数据库操作增强
